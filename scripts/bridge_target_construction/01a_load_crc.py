...
BASE = Path(__file__).resolve().parent   # .../Datasets_Visium_DH_FF

# Load CRC expression (8um)
# Load CRC clusters
matrix_h5 = BASE / "CRC" / "outs" / "binned_outputs" / "square_008um" / "filtered_feature_bc_matrix.h5"
clusters_csv = BASE / "Graph-Based_colon_cancer_008um.csv"
out_h5ad = BASE / "output" / "crc_008um.h5ad"
